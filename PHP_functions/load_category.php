      ...
      $query = "SELECT id, title, description_c, images_path, category_id, author, id_us FROM $tabella WHERE status_bool = 2 AND category_id = $id ORDER BY boost_start DESC, views DESC LIMIT " . $_GET['start'] . ", " . $_GET['tot'];
