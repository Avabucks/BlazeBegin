<?php
    ...
    $query = "SELECT id, title, description_c, images_path, category_id, author, id_us, likes FROM $tabella_startups WHERE status_bool = 2 ORDER BY boost_start DESC, likes DESC, views DESC LIMIT " . $_GET['start'] . ", " . $_GET['tot'];
